...
data$time <- as.POSIXct(as.numeric(as.POSIXct(data$Date, format = timeformat, tz = "UTC", origin = "1970-01-01"), tz = "UTC"), tz = "UTC", origin = "1970-01-01")
...
output <- ddply(data, .(StoreID), stlets.single.id)
